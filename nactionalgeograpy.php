                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                <h2>Nuestros Revistas</h2>
                                <span>Inicio / <a href="apicultura.php">National Geographic</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div id="product-heading">
                                <h2>CATEGORIAS:National Geographic</h2>
                    ...
                    <div class="row" id="Container">
                         <div class="row">
                      <?php 
                $query = mysql_query("SELECT * FROM libros where CategoriaLibro='National Geographic' AND  TipoLibro='Revistas'",$conexion);
