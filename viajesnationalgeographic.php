                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                ...
                                <span>Inicio / <a href="apicultura.php">Viajes National Geographic</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div id="product-heading">
                                <h2>CATEGORIAS:Viajes National Geographic</h2>
                    ...
                    <div class="row" id="Container">
                         <div class="row">
                      <?php 
                $query = mysql_query("SELECT * FROM libros where CategoriaLibro='Viajes National Geographic' AND  TipoLibro='Revistas'",$conexion);
