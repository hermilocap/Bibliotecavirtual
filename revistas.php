                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                ...
                                <span>Inicio / <a href="revistas.php">Categorias</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="filters col-md-12 col-xs-12">
                            <ul id="filters" class="clearfix">
                                <li><span class="filter" data-filter="all"><a href="revistas.php">Todos</a></span></li>
                                <li><span class="filter" data-filter="all"><a href="androidmagazine.php">Android Magazine</a></span></li>
                                <li><span class="filter" data-filter="all"><a href="historynationalgeograpy.php">Historia National Geographic</a></span></li>
                                <li><span class="filter" data-filter="all"><a href="nactionalgeograpy.php">National Geographic</a></span></li>
                                <li><span class="filter" data-filter="all"><a href="muyinteresante.php">Muy Interesante</a></span></li>
                                <li><span class="filter" data-filter="all"><a href="computerhoy.php">Computer Hoy</a></span></li>
                                <li><span class="filter" data-filter="all"><a href="viajesnationalgeographic.php">Viajes National Geographic</a></span></li>
                    ...
                    <div class="row" id="Container">
                         <div class="row">
                      <?php 
                $query = mysql_query("SELECT * FROM libros where Destacado=1 AND  TipoLibro='Revistas'",$conexion);
