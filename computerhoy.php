                ...
                <div id="main-header">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="logo">
                                    <a href="#"><img src="images/logo.png" widthe="100" height="130" title="CBTa N°178" alt="Grill Website Template" ></a>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="main-menu">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                ...
                                <span>Inicio / <a href="apicultura.php">Apicultura</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post">
                <div class="container">
                    ...
                    <div class="row" id="Container">
                         <div class="row">
                      <?php 
                $query = mysql_query("SELECT * FROM libros where CategoriaLibro='Computer Hoy' AND  TipoLibro='Revistas'",$conexion);
