                        ...
                        <div class="row">
                                ...
                                <div class="main-menu">
                                    <ul>
                                       <li><a href="index.php">Inicio</a></li>
                                        <li><a href="products.php">Categorias</a></li>
                                        <li><a href="contact-us.php">Nosotros</a></li>
                                        <li><a href="contact-us.php">Links</a></li>
                            ...
                            <div class="col-md-3">
                                <div class="search-box">  
                                    <form name="search_form" method="get" class="search_form" action="buscador.php">
                                        <input id="search" type="text" name="titulo" />
                                        <input type="submit" id="search-button" value="buscar" title="buscar" />
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-content">
                                ...
                                <span><a href="products.php">Libros</a></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div id="products-post">
                <div class="container">
                    ...
                    <div class="row" id="Container">
                         <div class="row">
                      <?php 
                $query = mysql_query("SELECT * FROM libros where CategoriaLibro='Computacion'",$conexion);
